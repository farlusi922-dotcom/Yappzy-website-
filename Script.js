...
try {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (!registrationForm) {
            ...
            return; // Stop script if main element is missing
        }
        ...
        registrationForm.addEventListener('submit', async (event) => {
            ...
            if (bulletSound) { bulletSound.currentTime = 0; bulletSound.play().catch(e => console.error("Bullet sound failed:", e)); }
        ...
        async function openGift(clickedScene) {
            if (boxOpenSound) { boxOpenSound.currentTime = 0; boxOpenSound.play().catch(e => console.error("Box sound failed:", e)); }
        ...
        shareBtn.addEventListener('click', async () => {
            ...
            if (navigator.share) {
                ...
                navigator.clipboard.writeText(shareData.url).then(() => {
                    ...
                    setTimeout(() => { shareBtn.textContent = 'Share Now'; }, 2000);
                });
            }
        });
        ...
        document.addEventListener('visibilitychange', () => {
            ...
            if (document.visibilityState !== 'visible') {
                ...
                backgroundMusic.play().catch(e => console.error("Music resume failed:", e));
            }
        });
    ...
    console.error("A fatal error occurred during Firebase initialization:", e);
